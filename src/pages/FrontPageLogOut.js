...
import './FrontPage.css'; // Ensure this CSS file styles the components correctly
import logo from './satyamev.jpg'; // Ensure the logo image is in the correct path
...
const FrontPageLogOut = ({ handleLogout }) => {
    ...
    <div className="frontpage-container">
      ...
      <nav className="main-nav">
        ...
        <ul className={`nav-links ${menuOpen ? 'open' : ''}`}>
          ...
          <li><Link to="/" onClick={handleLogoutClick}>Log Out</Link></li> {/* Updated */}
        </ul>
      </nav>
      ...
      <div className="two-column-container">
        ...
        <div className="right-column">
          ...
          <div className="card">
            ...
            <Link to="/profile-page" className="card-link">Go to Profile</Link>
            </div>
            </div>
            </div>
            <div className="card">
            ...
            <div className="card">
              <div className="card-content">
                <div className="text-content">
                  ...
                  <Link to="/claim-report" className="card-link">Claim Report</Link>
                </div>
...
export default FrontPageLogOut;
