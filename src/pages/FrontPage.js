    ...
    <div className="frontpage-container">
      ...
      <nav className="main-nav">
        ...
        <ul className={`nav-links ${menuOpen ? 'open' : ''}`}>
          ...
          <li><Link to="/login">Alert</Link></li>
          <li><Link to="/login">Safety Guidelines</Link></li>
        ...
        <div className="left-column">
          ...
          <div className="quick-links-container">
            ...
            <ul className="quick-links-list">
              ...
              <li><Link to="/login">Record Updated Safety</Link></li>
              <li><Link to="/login">Claim Report Page</Link></li>
              <li><Link to="/login">Apply for Leave</Link></li>
            </ul>
          </div>
        </div>
            ...
            <div className="card">
              <div className="card-content">
                <div className="text-content">
                  ...
                  <Link to="login" className="card-link">View Record</Link>
                </div>
            ...
            <div className="card">
              <div className="card-content">
                <div className="text-content">
                  ...
                  <Link to="/login" className="card-link">View Log</Link>
                </div>
            ...
            <div className="card">
              <div className="card-content">
                <div className="text-content">
                  ...
                  <Link to="/login" className="card-link">Update Safety</Link>
                </div>
            ...
            <div className="card">
              <div className="card-content">
                <div className="text-content">
                  ...
                  <Link to="/login" className="card-link">Claim Report</Link>
                </div>
            ...
            <div className="card">
              <div className="card-content">
                <div className="text-content">
                  ...
                  <Link to="/login " className="card-link">Apply Here</Link>
                </div>
